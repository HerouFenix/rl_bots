...
from plays.actions.drive import AdvancedDrive
...
class Refuel(Play):
    ...
    def __init__(self, agent, state, forbidden_pads = set()):
        ...
        self.travel = AdvancedDrive(agent, self.pad.position if self.pad else state.net.center, use_boost=True)
